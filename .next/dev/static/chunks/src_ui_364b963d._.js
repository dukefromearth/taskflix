...
"[project]/src/ui/components/command-palette.tsx [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {

const e = new Error("Could not parse module '[project]/src/ui/components/command-palette.tsx'\n\nExpected '</', got '}'");
...
const DetailPane = ({ itemId, onClose })=>{
    ...
    const setPaletteOpen = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ui$2f$state$2f$ui$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUiStore"])({
        "DetailPane.useUiStore[setPaletteOpen]": (state)=>state.setPaletteOpen
    }["DetailPane.useUiStore[setPaletteOpen]"]);
...
_s(DetailPane, "nNSOHB6OE0d6uxbbo9y4OQoiQzY=", false, function() {
    return [
...
//# sourceMappingURL=src_ui_364b963d._.js.map