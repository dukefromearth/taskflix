...
"[project]/app/api/views/[name]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const ParamsSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    name: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].enum([
        'today',
        'upcoming',
        'inbox',
        'history',
...
async function GET(request, context) {
    try {
        ...
        if (params.name === 'today') return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$next$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonOk"])(await service.getTodayView(now));
        if (params.name === 'upcoming') return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$next$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonOk"])(await service.getUpcomingView(now));
        if (params.name === 'inbox') return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$next$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonOk"])(await service.getInboxView(now));
        if (params.name === 'history') return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$next$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonOk"])(await service.getHistoryView(now));
        const projectId = searchParams.get('projectId');
        if (!projectId) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$next$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonOk"])({
                ok: false,
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$next$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonOk"])(await service.getProjectView(projectId, now));
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__69c5c5f2._.js.map