...
"[project]/app/api/items/[itemId]/attachments/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const BodySchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    originalName: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().min(1).max(255),
    mimeType: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$schemas$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MimeTypeSchema"],
    contentBase64: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$schemas$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Base64Schema"]
});
async function POST(request, context) {
    try {
        ...
        const body = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$next$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseRequestJson"])(request, BodySchema);
        ...
        const storage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$service$2d$context$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getStorage"])();
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$next$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withIdempotency"])(request, 'attachment.upload', async ()=>{
            ...
            if (fileBuffer.length > maxBytes) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$contracts$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ApiHttpError"](413, 'PAYLOAD_TOO_LARGE', 'Payload too large', {
                    maxBytes
                });
            }
            const key = `${params.itemId}/${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ulid$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ulid"])()}`;
            await storage.put({
                key,
                body: fileBuffer,
            ...
            const attachment = await service.addAttachment({
                ...
                sha256: (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$crypto__$5b$external$5d$__$28$node$3a$crypto$2c$__cjs$29$__["createHash"])('sha256').update(fileBuffer).digest('hex')
            });
            ...
            return {
                status: 201,
                payload: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$contracts$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ok"])(attachment)
            };
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(response.payload, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__862d68f5._.js.map